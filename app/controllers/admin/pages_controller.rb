class Admin::PagesController < ApplicationController
  ...
  def create
    ...
    if @page.save
      redirect_to [:admin, @prototype, @page], notice: 'Page was successfully created.'
    else
      render action: "new"
    end
  end
  ...
  def update
    if @page.update_attributes(params[:page])
      redirect_to [:admin, @prototype, @page], notice: 'Page was successfully updated.'
    else
      render action: "edit"
    end
  end
  ...
  def destroy
    ...
    redirect_to admin_prototype_pages_path
  end
