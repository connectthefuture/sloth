...
class PageVersionTest < ActiveSupport::TestCase
  ...
  describe "#current?" do
    test "should compare its self to the current on the page" do
  ...
  describe "#copy_links_from_previous_version" do
    test "should copy in the links as expected" do
  ...
  describe "#previous_version" do
    test "should look up its previous version" do 
